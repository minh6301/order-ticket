...
<head>
    ...
    <title>Sửa thông tin người quản lý</title>
</head>
...
<body>
        ...
        <div class="table-add">
            <table>
                <?php
                            ...
                            $sql = "SELECT * FROM tbl_user WHERE STT=$STT";
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <tr class="submit">
                        <td colspan="2">
                            ...
                            <button class="exit"><a href="<?php echo SITEURL;?>admin/page/user.php"><i
    ...
    if(isset($_POST['submit']))
    {
        ...
        if($res==TRUE)
        {
            $_SESSION['update-user']=`"<div style="color:green">Thêm thành công</div>"`;
            header("location:".SITEURL."/admin/page/user.php");
        }
        else
        {
            $_SESSION['update-user']=`<div style="color:red">Thêm không thành công</div>`;
